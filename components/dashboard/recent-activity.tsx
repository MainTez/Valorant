...
const VERB_LABEL: Record<string, string> = {
  ...
  tournament_prep_checklist_updated: "updated tournament prep",
  tournament_prep_notes_updated: "updated tournament notes",
  tournament_prep_ready_updated: "updated tournament ready check",
